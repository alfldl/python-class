...
def insert_books():
    ...
    # 데이터 입력
    cur.execute("INSERT INTO my_books VALUES ('삼국지', '2020.02.28','A', 200, 0)")
   # 데이터 입력 SQL
    insert_sql = 'INSERT INTO my_books VALUES (?, ?, ?, ?, ?)'
    # 튜플을 이용한 데이터 입력
    cur.execute(insert_sql, ('초한지', '2020.04.27','B', 584, 1))
    # 책의 정보를 담고 있는 튜플들의 리스트
    books = [
        ('빅데이터 마케팅', '2014.07.02','A', 296, 1),
        ('구글', '2010.02.10','B', 526, 0),
        ('아름다운노래', '2013.12.12','A', 248, 1)
    ]
